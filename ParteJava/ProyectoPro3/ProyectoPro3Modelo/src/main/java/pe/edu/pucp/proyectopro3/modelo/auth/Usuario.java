...
public class Usuario {
    ...
    public Usuario(int idUsuario, String nombres, String apellidos, TipoDocumento tipoDocumento, String numeroDocumento, String correo, String contrasena, String numeroContacto) {
