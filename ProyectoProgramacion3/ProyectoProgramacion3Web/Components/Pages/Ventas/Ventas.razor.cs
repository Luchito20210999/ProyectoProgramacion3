    ...
    public partial class Ventas : ComponentBase
    {
        ...
        private string UrlReportePdf
        {
            get
            {
                ...
                return $"{baseUrl.TrimEnd('/')}/ventas?fechaInicio={fInicio}&fechaFin={fFin}&servicio={servicio}&canal={canal}";
            }
        }
        ...
        private void CargarDatosIniciales()
        {
            MasterReservas = ReservasServiceClient.Listar().Select(r => new VentaReservaItem
            {
                ...
                Pax = r.Pax,
                Monto = r.Monto,
                Canal = r.Codigo.StartsWith("RES-", StringComparison.OrdinalIgnoreCase) ? "Interno" : "Bokun"
            }).ToList();
