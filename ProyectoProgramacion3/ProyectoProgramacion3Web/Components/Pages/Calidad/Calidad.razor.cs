    ...
    public partial class Calidad : ComponentBase
    {
        ...
        private string UrlReportePdf
        {
            get
            {
                ...
                return $"{baseUrl.TrimEnd('/')}/calidad?fechaInicio={fInicio}&fechaFin={fFin}&servicio={servicio}";
            }
        }
        ...
        private void CargarDatosIniciales()
        {
            ...
            ServiciosDisponibles = MasterReservas
                .Select(r => r.Servicio)
        ...
        public async Task GenerarReporte()
        {
            ...
            Auditoria.Registrar(
                ...
                "Modulo Reportes",
                $"exporto el reporte de calidad en PDF con {ReclamosCount} reclamos filtrados.");
        ...
        public async Task ExportarACsv()
        {
            ...
            Auditoria.Registrar(
                "EXPORTAR_REPORTE_CALIDAD",
                "Modulo Reportes",
                $"exporto el reporte de calidad con {ReclamosCount} reclamos filtrados.");
        }
